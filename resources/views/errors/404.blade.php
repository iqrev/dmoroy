...
@section('title', '404 - Halaman Tidak Ditemukan | ' . \App\Models\Setting::get('site_name', "D'Moroy"))
    ...
    <div class="max-w-xl w-full text-center space-y-10 py-20">
        ...
        <div class="relative inline-block">
            ...
            <div class="relative flex items-center justify-center">
                <span class="text-[150px] md:text-[200px] font-serif font-black text-brand-brown opacity-10">404</span>
        ...
        <div class="flex flex-col sm:flex-row gap-4 justify-center pt-4">
            <a href="{{ route('home') }}" 
               class="inline-flex items-center px-8 py-3.5 bg-brand-brown text-white text-sm font-bold rounded-xl hover:bg-red-700 transition-all duration-300 shadow-xl shadow-brand-brown/20 group">
        ...
        <div class="flex justify-center gap-2 opacity-20">
            ...
            <div class="w-2 h-2 rounded-full bg-brand-brown"></div>
            <div class="w-2 h-2 rounded-full bg-brand-gold"></div>
        </div>
    </div>
</div>
