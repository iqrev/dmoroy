...
>
    ...
    <div class="flex-1 relative flex flex-col lg:flex-row overflow-hidden">
        ...
        <div class="curator-panel-gallery flex-1 h-full overflow-auto p-4">
            <ul class="curator-picker-grid grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4">
            ...
            @if($currentPage < $lastPage)
                <div 
                    class="mt-8 mb-4 flex justify-center items-center w-full" 
                    x-intersect="$wire.loadMoreFiles()"
                >
                    <x-filament::button
                        size="sm"
                        color="primary"
                    ...
                    >
                        <span wire:loading.remove wire:target="loadMoreFiles">Tampilkan Lebih Banyak...</span>
                        <span wire:loading wire:target="loadMoreFiles">Memuat Gambar...</span>
                    </x-filament::button>
                </div>
            @endif
        </div>
